...
static char *camera_fixup_getparams(int id, const char *settings)
{
    ...
    if (get_product_device() == DUDIN || get_product_device() == PEREGRINE) {
        if (id == BACK_CAMERA) {
...
static char *camera_fixup_setparams(int id, const char *settings)
{
     ...
     * vendor call, unless the zte camera app is used. Save the value
    ...
    if (get_product_device() == TITAN || get_product_device() == DUDIN) {
